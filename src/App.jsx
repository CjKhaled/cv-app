...
function App() {
  ...
  function changeExistingJobInfo(existingCompany, existingPosition, existingStart2, existingEnd2, existingLocation2, existingDesc) {
    ...
    <main>
      <div className="app-container">
        <div className="edit-side">
          ...
          <Experience company={company} position={position} start2={start2} end2={end2} location2={location2} desc={desc} handleCompanyChange={handleCompanyChange} handlePositionChange={handlePositionChange}  handleStart2Change={handleStart2Change}  handleEnd2Change={handleEnd2Change} handleLocation2Change={handleLocation2Change}  handleDescChange={handleDescChange} clearText={clearExperienceText} changeExistingJobInfo={changeExistingJobInfo} />
        </div>
